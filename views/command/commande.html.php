...
<fieldset>
  ...
  <?php foreach ($comm as $cmd) :?>
    <tr>
      ...
      <td><a href="<?=WEB_ROUTE.'?controlleur=commande&views=edit&id_produit='.$cmd['id_commande']?>" title="Modifier"><i class="bi bi-pencil-square"></i></a> <a href="" title="Suprimer" ><i class="bi bi-trash" ></i></a></td>
    </tr>
    <?php endforeach  ?>
  </tbody>
</table>
